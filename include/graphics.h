...
int setup(PANEL* panelptr) {
	...
	start_color();
	init_pair(COLOUR_RED, COLOR_RED, COLOR_BLACK);
	init_pair(COLOUR_GREEN, COLOR_GREEN, COLOR_BLACK);
	init_pair(COLOUR_BLUE, COLOR_BLUE, COLOR_BLACK);
	init_pair(COLOUR_CYAN, COLOR_CYAN, COLOR_BLACK);
	init_pair(COLOUR_MAGENTA, COLOR_MAGENTA, COLOR_BLACK);
	init_pair(COLOUR_YELLOW, COLOR_YELLOW, COLOR_BLACK);
	init_pair(COLOUR_WHITE, COLOR_WHITE, COLOR_BLACK);
	init_pair(COLOUR_BLACK, COLOR_BLACK, COLOR_BLACK);
